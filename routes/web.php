...
Route::group(['prefix' => 'products','middleware'=>['auth']], function () {
    ...
    Route::get('/edit/images/{id}','ProductController@imagesEdit')->name('products.images');
    Route::post('/update/images','ProductController@updateImages')->name('products.update.image');
